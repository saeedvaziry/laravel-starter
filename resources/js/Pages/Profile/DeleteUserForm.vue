<template>
    <v-action-section>
        ...
        <template #content>
            ...
            <div class="mt-5">
                <v-danger-button @click="confirmUserDeletion">
                    Delete Account
                </v-danger-button>
            </div>

            <!-- Delete Account Confirmation Modal -->
            <v-dialog-modal :show="confirmingUserDeletion" @close="closeModal">
                <template #title>
                    Delete Account
                </template>
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <v-input type="password" class="mt-1 block w-full" placeholder="Password"
                                    ref="password"
                ...
                <template #footer>
                    <v-secondary-button @click="closeModal">
                        Cancel
                    </v-secondary-button>

                    <v-danger-button class="ml-2" @click="deleteUser" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Delete Account
                    </v-danger-button>
                </template>
            </v-dialog-modal>
